...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  test('Verifica se caso o parâmetro passado não seja um número a função `circle` retorna undefined', () => {
    expect(circle('1')).toBeUndefined();
  });
  test('Verifica se a função `circle` retorna um objeto', () => {
    expect(circle(1)).toMatchObject({radius: 1, area: 3.14, circumference: 6.28});
  });
  test('Verifica se a função `circle` retorna um objeto com 3 propriedades', () => {
